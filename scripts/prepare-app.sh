...
git -C "$APP_DIR" apply --recount --check "$ROOT_DIR/patches/syll-recovery.patch"
git -C "$APP_DIR" apply --recount "$ROOT_DIR/patches/syll-recovery.patch"
git -C "$APP_DIR" apply --recount --check "$ROOT_DIR/patches/syll-shell-structural.patch"
